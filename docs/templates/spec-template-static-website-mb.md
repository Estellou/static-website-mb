...
**Problem:** The craftsman has no online presence — potential clients searching for carpentry services in Le Bouscat have no way to discover, evaluate, or contact him.
...
| Property             | Value                                             |
| -------------------- | ------------------------------------------------- |
| Target audience      | Individuals and businesses in the Le Bouscat area |
...
| 6   | Home: Add logo                                              | Done _(merged into Slice 2)_ |
...
| 12  | Home: Projects linked to `/contact?projectType=xxx` | Done _(later reverted)_ |
